...
{var vds='http://cdn.jsdelivr.net/gh/rabbit-wp/imge/5/lanzou/zh-wike.css';
 var vdx='<div>error message</div>';

{var p = document.createElement('div');
Object.defineProperty(p, 'id', {
  get:function(){
    // document.body.innerHTML=vdx;
